...
//previous.next arrows if pulling from image ARRAY
window.addEventListener('keydown', function (event) {
    if (event.keyCode === 37) {
...
//find the currentURLs index in the images array
    let index = imageInfo.indexOf(currentURL);
//increment the index
    index++;
...
//then return the imageURL at the new index
